...
<CardGroup cols={2}>
  ...
  <Card title="Icons & badges" icon="star" href="/features/badges-counters">
    Add WordPress Dashicons and dynamic counters
  </Card>
...
- **Dashicons** — WordPress native icon set (700+ icons available)
- **Visual icon picker** — 36+ quick-pick icons in the editor
- **Manual input** — Use any Dashicons CSS class
- **Zero additional weight** — Icons are bundled with WordPress core
